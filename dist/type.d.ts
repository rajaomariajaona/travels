import type { Options as MutativeOptions, Patches, Draft, Immutable, PatchesOptions } from 'mutative';
...
export type TravelsOptions<F extends boolean, A extends boolean, P extends PatchesOption = {}> = {
    /**
...
export type InitialValue<I extends unknown> = I extends (...args: unknown[]) => infer R ? R : I;
type DraftFunction<S> = (draft: Draft<S>) => void;
export type Updater<S> = S | (() => S) | DraftFunction<S>;
export type Value<S, F extends boolean> = F extends true ? Immutable<InitialValue<S>> : InitialValue<S>;
export interface TravelsControls<S, F extends boolean, P extends PatchesOption = {}> {
    /**
...
export interface ManualTravelsControls<S, F extends boolean, P extends PatchesOption = {}> extends TravelsControls<S, F, P> {
    /**
